...
import com.scratchdeveloper.photoapp.api.users.service.UsersService;
...
public class WebSecurity extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable();
		http.authorizeRequests().antMatchers("/**").permitAll()//hasIpAddress(env.getProperty("gateway.ip"))
		.and()
